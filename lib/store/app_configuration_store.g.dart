...
mixin _$AppConfigurationStore on _AppConfigurationStore, Store {
  ...
  late final _$cancellationChargeAmountAtom =
      Atom(name: '_AppConfigurationStore.cancellationChargeAmount', context: context);
  ...
  set cancellationChargeAmount(num value) {
    _$cancellationChargeAmountAtom.reportWrite(value, super.cancellationChargeAmount, () {
      super.cancellationChargeAmount = value;
    });
  }


  late final _$cancellationChargeHoursAtom =
      Atom(name: '_AppConfigurationStore.cancellationChargeHours', context: context);
  ...
  set cancellationChargeHours(int value) {
    _$cancellationChargeHoursAtom.reportWrite(value, super.cancellationChargeHours, () {
  ...
  late final _$setCancellationChargeAmountAsyncAction =
      AsyncAction('_AppConfigurationStore.setCancellationChargeAmount', context: context);

  @override
  Future<void> setCancellationChargeAmount(num val) {
    return _$setCancellationChargeAmountAsyncAction.run(() => super.setCancellationChargeAmount(val));
  }

   late final _$setCancellationChargeHoursAsyncAction =
      AsyncAction('_AppConfigurationStore.setCancellationChargeHours', context: context);

  @override
  Future<void> setCancellationChargeHours(int val) {
    return _$setCancellationChargeHoursAsyncAction.run(() => super.setCancellationChargeHours(val));
  }
